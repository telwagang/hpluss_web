...
var rxjs_1 = require("rxjs/Subject");
if (io && io.sails) {
...
var SailsService = (function() {
     ...
     *
     */
    SailsService.prototype.disconnect = function() {
    ...
    SailsService.prototype.on = function(eventIdentity) {
        ...
        if (!this._pubsubSubscriptions[eventIdentity] || this._pubsubSubscriptions[eventIdentity].isComplete) {
            this._pubsubSubscriptions[eventIdentity] = new rxjs_1.Subject();
            this.zone.runOutsideAngular(function() {
    ...
    /** @nocollapse */
    SailsService.ctorParameters = function() {
        return [
            { type: core_1.NgZone, },
        ];
    };
